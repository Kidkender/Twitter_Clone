...
import vn.sparkminds.be_twitter.services.dto.response.ApiResponse;
import vn.sparkminds.be_twitter.services.mapper.TwitDtoMapper;

import java.util.List;

@RestController
@RequestMapping("/api/v1/twit")
...
public class TwitController {
    ...
    public ResponseEntity<ApiResponse> deleteTwit(@PathVariable Long twitId,
        ...
        ApiResponse res = new ApiResponse("Twit Delelte Successfully", true);
